...
Pada tutorial ini, RwLock<> digunakan untuk mengizinkan banyak reader sekaligus tetapi hanya satu writer pada satu waktu, yang cocok untuk kasus di mana banyak thread perlu membaca data tetapi hanya satu yang perlu mengubahnya. Penggunaan RwLock<> lebih efisien daripada Mutex<> karena Mutex<> hanya mengizinkan satu thread pada satu waktu, yang dapat menghambat kinerja program karena thread lain harus menunggu untuk mendapatkan akses.
